...
const ProjectCard = ({ data, index, isDarkMode }: ProjectData) => {
    return (
        ...
        >
            ...
            <div
                className={`w-full lg:w-[60%]  flex flex-col justify-center ${isDarkMode ? "bg-zinc-900" : "bg-white"
                ...
                <div className="flex flex-wrap gap-4">
                    {data.showVideo && data.title !== "Nexora" && (
                        <motion.button>
                            <Link
                                to={`/watch/${index}`}
                                className="relative group border border-indigo-500 text-indigo-400 hover:text-white px-4 py-2 sm:px-4 sm:py-2 rounded-xl flex flex-row items-center justify-center gap-2 text-xs sm:text-sm font-medium transition-all duration-200 shadow-[0_0_10px_rgba(99,102,241,0.5)] hover:shadow-[0_0_20px_rgba(99,102,241,0.8)]"
                            >
                    ...
                    <a
                        ...
                        className="relative group border border-emerald-500 text-emerald-400 hover:text-white px-4 py-2 sm:px-4 sm:py-2 rounded-xl flex items-center justify-center gap-2 text-xs sm:text-sm font-medium transition-all duration-200 shadow-[0_0_10px_rgba(16,185,129,0.5)] hover:shadow-[0_0_20px_rgba(16,185,129,0.8)]"
                    >
